...
Route::middleware($middlewares)->group(function () {
    ...
    Route::prefix('/admin')->group(function () {
        ...
        Route::prefix('/role')->group(function () {
            ...
            Route::post('/sync_permission_names/{id}', [AdminRoleController::class, 'syncPermissionNames']);
            Route::post('/find_permission_names/{id}', [AdminRoleController::class, 'findPermissionNames']);
        });
    });
});
